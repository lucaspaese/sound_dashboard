...
# st.set_page_config(page_title="Hidden Sound Button", page_icon="🔊")

# st.title("🔊 Play sound without showing the player")

# # ---- Load the sound ----
# sound_file = "c:/codes_py/sound/Intensite.mp3"  # put your mp3 or wav file in the same folder

# with open(sound_file, "rb") as f:
#     data = f.read()
#     b64 = base64.b64encode(data).decode()

# # ---- HTML with button and sound ----
# html_code = f"""
# <!DOCTYPE html>
# <html>
#   <body>
#     <audio id="sound" src="data:audio/mp3;base64,{b64}"></audio>
#     <button style="
